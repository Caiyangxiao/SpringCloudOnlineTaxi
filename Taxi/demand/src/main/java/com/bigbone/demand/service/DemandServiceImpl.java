...
public class DemandServiceImpl implements DemandService{
    ...
    @Override
    public List<Demand> findAll2(String address, int start, int row) {
        return demandDao.findAll2(address, start, row);
    }
...
//    }
    ...
    @Override
    public void saveShare(Demand demand) {
        demandDao.saveShare(demand);
    }
