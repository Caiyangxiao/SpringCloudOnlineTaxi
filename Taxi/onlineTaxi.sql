...
CREATE TABLE `t_demand` (
  ...
  `name` varchar(20) DEFAULT NULL,
  `type` varchar(20) DEFAULT 'own', -- 打车类型:默认own 约车,share 拼车
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

/*Data for the table `t_demand` */

insert  into `t_demand`(`id`,`departure`,`destination`,`name`,`type`) values (16,'A2','A8','passenger1','own');
...
CREATE TABLE `t_order` (
  ...
  `type` varchar(20) DEFAULT 'own',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=dec8;

/*Data for the table `t_order` */

insert  into `t_order`(`id`,`departure`,`destination`,`state`,`passenger`,`driver`,`price`,`type`) values (6,'A1','B1',1,'passenger','driver',16,'own'),(8,'A1','F1',1,'passenger','driver',80,'own'),(10,'A1','A9',1,'passenger','driver',8,'own'),(11,'A1','A3',1,'passenger','driver',2,'own');
