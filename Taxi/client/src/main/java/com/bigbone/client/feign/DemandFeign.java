...
public interface DemandFeign {
    ...
    @GetMapping("/demand/getDriverShareDemand/{address}/{start}/{row}")
    List<Demand> getDriverShareDemand(@PathVariable("address") String address, @PathVariable("start") int start, @PathVariable("row") int row);
    ...
    @PostMapping("/demand/save/share")
    Result saveShare(Demand demand);
